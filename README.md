...
> 최홍석
>
> - 프로젝트를 기간안에 완성하기 위해 빠르게 달려온 것 같습니다. 빠르게 지나간 만큼 코드의 구조적 디테일을 놓친부분이 많았고, 처음 세팅시 잡은 구조를 지키지 못한 점 이 있었습니다. 이번 프로젝트를 통해 JS의 3D 라이브러리인 Tree.js를 다뤄볼 수 있어서 의미가 있었던 경험이었다.
