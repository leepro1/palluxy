...
public class GroupController {
    ...
    public CommonResponse<?> getGroupsByStatus(@PathVariable("status") String status) {
        ...
        List<GroupResponse> groupResponseList = groupUtil.convertToDtoList(groupService.findByStatus(statusEnum));
    ...
    public CommonResponse<?> updateGroup(@PathVariable("groupId") Long groupId, @RequestBody GroupRequest groupRequest) {
    ...
    public CommonResponse<?> createJoin(@PathVariable("groupId") Long groupId, @RequestBody GroupRequest groupRequest) {
    ...
    public CommonResponse<?> cancelJoin(@PathVariable("groupId") Long groupId, @RequestBody GroupRequest groupRequest) {
